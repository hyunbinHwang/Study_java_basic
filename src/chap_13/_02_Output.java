...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%06d%n", 1234); // 001234 (6자리의 공간 확보후 1234 출력하는데 빈 공간은 0 으로 채움)
